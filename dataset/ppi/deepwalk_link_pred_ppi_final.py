...
ppi_edge_file_train = "ppi_edge_list_train.txt"
...
ppi_edge_file_test = "ppi_edge_list_test_with_pos_neg.txt"
...
win_size = 5
n_walk = 10 
output_file = "ppi_embad.txt"


# In[25]:


command = "deepwalk --format edgelist --number-walks " + str(n_walk) + " --representation-size " + str(rep_size) + " --walk-length " + str(walk_len) + " --window-size " + str(win_size) + " --undirected true --input " + ppi_edge_file_train + " --output " + output_file + " --workers 8"
...
f= open("result_linkpred_ppi_deepwalk.txt","a+")
f.write(result)
f.close()
print(result)
